...
object Translations {
    ...
    private val es: Map<String, String> = mapOf(
        ...
        "register.privacy_body_4" to "Puedes solicitar acceso, rectificación o eliminación de tus datos personales en cualquier momento contactando al soporte de la app.",
